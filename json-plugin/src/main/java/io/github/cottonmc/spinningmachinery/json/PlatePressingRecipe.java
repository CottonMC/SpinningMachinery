...
final class PlatePressingRecipe extends AbstractContentGenerator {
    PlatePressingRecipe() {
        super("recipe.spinning-machinery.plate_pressing", "recipes/pressing", SpinningJsonPlugin.INFO, "json", ResourceRoot.Data);
    }
